...
## 📊 Comparación de Teorías Aplicadas
...
<div class="recuadro-info elemento-didactico">
  <table>
    <thead>
      <tr>
        <th>Categoría</th>
        <th>Sistemas Dinámicos</th>
        <th>Enfoque Ecológico</th>
      </tr>
    </thead>
    <tbody>
      <tr>
        <td><strong>Fundamentos</strong></td>
        <td>Interacción organismo-tarea-entorno</td>
        <td>Percepción-acción en entorno</td>
      </tr>
      <tr>
        <td><strong>Variabilidad</strong></td>
        <td>Necesaria para estabilización de patrones</td>
        <td>Surge de exploración perceptiva</td>
      </tr>
      <tr>
        <td><strong>Metodología</strong></td>
        <td>Manipulación de restricciones</td>
        <td>Actividades de exploración</td>
      </tr>
      <tr>
        <td><strong>Torpeza acuática</strong></td>
        <td>Desajuste capacidades-demandas</td>
        <td>Déficit en percepción-acción</td>
      </tr>
    </tbody>
  </table>
</div>
...
## 2.2 Dimensión Emocional del Aprendizaje Acuático
...
## 2.3 La Técnica como Eje del Aprendizaje
